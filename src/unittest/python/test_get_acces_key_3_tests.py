...
class MyTestCase(unittest.TestCase):
    ...
    def test_sintaxis_str_nombre2_elim(self):
        ...
        path = path.joinpath("src/jsons_e2/sintaxis_n41.json")
    ...
    def test_sintaxis_str_nombre2_dup(self):
        """Nodo 32 duplicado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n42.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR, typo en clave \"DNI\"")
    ...
    def test_sintaxis_str_valor2_elim(self):
        """Nodo 36 eliminado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n43.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
    ...
    def test_sintaxis_str_valor2_sup(self):
        """Nodo 36 duplicado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n44.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR, typo en DNI")
    ...
    def test_sintaxis_str_nombre3_elim(self):
        """Nodo 39 eliminado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n45.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
    ...
    def test_sintaxis_str_nombre3_dup(self):
        """Nodo 39 duplicado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n46.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR, typo en clave \"NotificationMail\"")
    ...
    def test_sintaxis_corchete_abierto_elim(self):
        """Nodo 42 eliminado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n47.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
    ...
    def test_sintaxis_corchete_abierto_dup(self):
        """Nodo 42 duplicado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n48.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR DE SINTAXIS EN ARCHIVO")
    ...
    def test_sintaxis_str_emails_elim(self):
        """Nodo 43 eliminado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n49.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
    ...
    def test_sintaxis_emails_coma_elim(self):
        """Nodo 43 duplicado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n50.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR DE SINTAXIS EN ARCHIVO")
    ...
    def test_sintaxis_corchete_cerrado_elim(self):
        """Nodo 44 eliminado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n51.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR DE SINTAXIS EN ARCHIVO")
    ...
    def test_sintaxis_corchete_cerrado_dup(self):
        """Nodo 44 duplicado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n52.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR DE SINTAXIS EN ARCHIVO")
    ...
    def test_sintaxis_comilla_typo(self):
        """Nodo 45 modificado"""
        path = pathlib.Path(__file__).parent.parent.parent.parent
        path = path.joinpath("src/jsons_e2/sintaxis_n55.json")
        with self.assertRaises(AccessManagementException) as res:
            AccessManager().get_access_key(path)
        self.assertEqual(res.exception.message, "ERROR DE SINTAXIS EN ARCHIVO")
